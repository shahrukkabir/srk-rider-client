...
const reviews = [
    {
        ...
        feedback:
            'SrkRider Courier has made my e-commerce deliveries seamless and reliable. The real-time tracking and fast delivery give me and my customers peace of mind.',
    ...
    },
    {
        ...
        role: 'CTO',
        feedback:
            'Their 24/7 support and safe delivery process are unmatched. I trust SrkRider for all my business shipments across Bangladesh.',
    ...
    },
    {
        ...
        role: 'Merchant',
        feedback:
            'SrkRider Courier has helped my business grow with their reliable service and excellent customer support.',
        avatar: '',
    },
];
            ...
            <div className="max-w-6xl mx-auto">
                <div className="flex flex-col items-center mb-6">
                    ...
                    <p className="text-gray-500 text-center max-w-2xl mx-auto mb-4 text-base md:text-lg">
                        Enhance posture, mobility, and well-being effortlessly with SrkRider
                ...
                <div className="flex items-center gap-4 mt-6 w-2/8 mx-auto ">
                    ...
                    <button className="swiper-next w-8 h-8 rounded-full bg-[#CAEB66] flex items-center justify-center text-sm text-[#184042]">
...
export default WhatOurCustomerSaid;